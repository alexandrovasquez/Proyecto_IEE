...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
 ...
 <br></br>
            <img id="profile-img" class="profile-img-card" src="/ProyectoFinal/imagenes/usuario.png"/ width=13% height=20% />
         	<form class="form-signin" method="POST" action="loginapoderado.php">

<label>Usuario</label>
<input type="text" name="Nombres"  class="form-control" placeholder="usuario">
<label>Clave</label>
<input type="password" name="DNIapoderado" class="form-control" placeholder="escriba su clave">
